# Task Description
Write a program to read the number of rows ($r$) and columns ($c$) of a two-dimensional integer array first, then read the array<br>elements row by row. Finally print the average (in integer) of every column.
# Limits
