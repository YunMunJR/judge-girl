...
# Output
Please output $N+1$ lines -- each has a fractional number. The $i$-line has the probability of the ball falling into the $i$-th bucket. Each<br>line has a ratio of $q/p$ to indicate the probability. You need to simplify the $q/p$ ratio; you should output 1/2 instead of 2/4.
# Sample input
```
2
1 2
